...
var ManualComponent = (function () {
    function ManualComponent(requestService) {
        this.requestService = requestService;
        this.success = new core_1.EventEmitter();
    }
    ManualComponent.prototype.onSubmit = function () {
        var _this = this;
    ...
    ], ManualComponent.prototype, "status", void 0);
    __decorate([
        core_1.Input('coupon'), 
        __metadata('design:type', Object)
    ], ManualComponent.prototype, "coupon", void 0);
    __decorate([
        core_1.Input('StatusList'), 
        __metadata('design:type', Object)
    ], ManualComponent.prototype, "StatusList", void 0);
    __decorate([
        core_1.Input('ExchangeDict'), 
        __metadata('design:type', Object)
    ], ManualComponent.prototype, "ExchangeDict", void 0);
    __decorate([
        core_1.Input('toast'), 
        __metadata('design:type', Object)
    ], ManualComponent.prototype, "toast", void 0);
    __decorate([
        core_1.Output('success'), 
        __metadata('design:type', Object)
    ], ManualComponent.prototype, "success", void 0);
