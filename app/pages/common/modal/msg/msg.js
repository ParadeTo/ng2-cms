...
var MsgComponent = (function () {
    function MsgComponent(formBuilder, requestService) {
        this.formBuilder = formBuilder;
        this.requestService = requestService;
        this.success = new core_1.EventEmitter();
        this.modalForm = this.formBuilder.group({
            giftContent: ['', common_1.Validators.required],
        });
        this.giftContent = this.modalForm.controls['giftContent'];
    }
    MsgComponent.prototype.onSubmit = function () {
        var _this = this;
    ...
    ], MsgComponent.prototype, "status", void 0);
    __decorate([
        core_1.Input('coupon'), 
        __metadata('design:type', Object)
    ], MsgComponent.prototype, "coupon", void 0);
    __decorate([
        core_1.Input('toast'), 
        __metadata('design:type', Object)
    ], MsgComponent.prototype, "toast", void 0);
    __decorate([
        core_1.Input('StatusList'), 
        __metadata('design:type', Object)
    ], MsgComponent.prototype, "StatusList", void 0);
    __decorate([
        core_1.Input('ExchangeDict'), 
        __metadata('design:type', Object)
    ], MsgComponent.prototype, "ExchangeDict", void 0);
    __decorate([
        core_1.Output('success'), 
        __metadata('design:type', Object)
    ], MsgComponent.prototype, "success", void 0);
